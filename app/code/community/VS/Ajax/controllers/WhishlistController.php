				...
				if (!$productId) {
					...
					if (!$product->getId() || !$product->isVisibleInCatalog()) {
						...
						try {
							...
							$response['counter'] =   $counter_wishlist;   //$params['qty'];
							
							## Prepare Remove Url 							
							$removeUrl=Mage::getBaseUrl()."flavors/index/remove/item/".$wishlist_item_id;
	...
	public function removeAction()
		{
                ...
                try {
					...
					## Prepare Remove Url 							
					$addUrl=Mage::getBaseUrl()."flavors/index/add/product/".$item->getProductId();
