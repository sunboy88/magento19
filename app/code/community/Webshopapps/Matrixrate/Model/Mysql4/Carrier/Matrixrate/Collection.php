...
class Webshopapps_Matrixrate_Model_Mysql4_Carrier_Matrixrate_Collection extends Varien_Data_Collection_Db
{
    ...
    public function __construct()
    {
        ...
        $this->_cityTable = Mage::getSingleton('core/resource')->getTableName('directory_country_region_city');
        $this->_select->from(array("s" => $this->_shipTable))
            ...
            ->joinLeft(array("t" => $this->_cityTable),'t.region_id like %s.dest_city%', 'region_id AS dest_city')
