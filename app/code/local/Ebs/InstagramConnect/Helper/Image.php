...
class Ebs_InstagramConnect_Helper_Image extends Mage_Core_Helper_Abstract
{
    const MAX_PHOTO_COUNT = 50;

	protected $_configPath = 'ebs_instagramconnect/module_options/states';
	...
	{
		return Mage::getStoreConfig('ebs_instagramconnect/module_options/client_id');
	}

	public function getTags()
	{
		$rawTags = Mage::getStoreConfig('ebs_instagramconnect/module_options/tags');
