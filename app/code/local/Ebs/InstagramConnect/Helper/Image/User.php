...
class Ebs_InstagramConnect_Helper_Image_User extends Ebs_InstagramConnect_Helper_Image
{
    ...
    {
        $rawUsers = Mage::getStoreConfig('ebs_instagramconnect/module_options/users');
    ...
    public function getSearchEndpointUrl($userId)
    {
        ...
        /** @var $helper Ebs_InstagramConnect_Helper_Data */
