...
class Droppin_SocialLogin_Block_Button_Type extends Mage_Core_Block_Template{
    ...
    public function __construct($name = null, $class = null, $title= null){
        ...
        $this->setTemplate('droppin_sociallogin/button/type.phtml');
    }
    ...
    protected function _getXmlPath(){
        $data = 'droppin_sociallogin/'.$this->getName().'/enabled';
        return $data;
    }
