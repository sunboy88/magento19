...
class Droppin_InstagramConnect_Helper_Image_User extends Droppin_InstagramConnect_Helper_Image
{
    ...
    {
        $rawUsers = Mage::getStoreConfig('droppin_instagramconnect/module_options/users');
    ...
    public function getSearchEndpointUrl($userId)
    {
        ...
        /** @var $helper Droppin_InstagramConnect_Helper_Data */
