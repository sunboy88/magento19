...
class Droppin_InstagramConnect_Helper_Data extends Mage_Core_Helper_Abstract
{
	public function isEnabled()
	{
		return (bool) Mage::getStoreConfig('droppin_instagramconnect/module_options/enabled');
	}
	
	public function showImagesOnProductPage()
	{
		return (bool) Mage::getStoreConfig('droppin_instagramconnect/module_options/product');
	}
	
	public function showImagesOnHomePage()
	{
		return (bool) Mage::getStoreConfig('droppin_instagramconnect/module_options/homepage');
	}
	
	public function getHomePageLimit()
	{
		return (int) Mage::getStoreConfig('droppin_instagramconnect/module_options/homepage_limit');
	}
	
	public function getProductPageLimit()
	{
		return (int) Mage::getStoreConfig('droppin_instagramconnect/module_options/product_limit');
	}
    ...
    public function getAdminConfigSectionUrl()
    {
        ...
        return $url->getUrl('adminhtml/system_config/edit', array(
            '_current'  => true,
            'section'   => 'droppin_instagramconnect'
        ));
    }
}
