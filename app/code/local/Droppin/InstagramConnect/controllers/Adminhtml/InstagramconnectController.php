...
class Droppin_InstagramConnect_Adminhtml_InstagramconnectController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function updateAction()
    {
        ...
        $updateType = Mage::getStoreConfig('droppin_instagramconnect/module_options/updatetype');
