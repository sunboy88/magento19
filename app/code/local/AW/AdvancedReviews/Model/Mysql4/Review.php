    ...
    {        
        ...
        if ( Mage::helper('advancedreviews')->confEnableUserDefined() )
        {
            ...
            if ( $userPros = Mage::registry( 'advancedreviews_proscons_user_pros' ) )
            {
                ...
                $pros = htmlspecialchars($userPros);
               ...
               // $pros = array_unique($pros);
                ...
                // }
                $this->_addUserProscons( $pros, Mage::helper('advancedreviews')->getConstTypePros() ,$object );
            }
            # Adding cons
            if ( $userCons = Mage::registry( 'advancedreviews_proscons_user_cons' ) )
            {
                $userCons = trim($userCons);
                $cons = htmlspecialchars($userCons);
                ...
                // }
                $this->_addUserProscons( $cons, Mage::helper('advancedreviews')->getConstTypeCons() ,$object );
            }
        }
        # Add recommend
